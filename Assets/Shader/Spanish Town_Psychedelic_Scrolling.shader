Shader "Spanish Town/Psychedelic_Scrolling" {
	Properties {
		_Layer01 ("Layer01", 2D) = "white" {}
		_Layer01_Color ("Layer01_Color", Vector) = (1,0.4433962,0.4433962,0)
		_Layer01_Emissive_Intensity ("Layer01_Emissive_Intensity", Float) = 0
		_Layer01_Contrast ("Layer01_Contrast", Float) = 1
		_Layer_01_Speed ("Layer 01 Speed", Vector) = (0.1,0.1,0,0)
		[ToggleUI] _Enable_wind ("Enable wind", Float) = 0
		_Wind_Direction ("Wind Direction", Vector) = (1,0,0,0)
		_Wind_Large_Scale ("Wind Large Scale", Float) = 2
		_Wind_Large_Speed ("Wind Large Speed", Float) = 2
		_Wind_Large_Intensity ("Wind Large Intensity", Float) = 2
