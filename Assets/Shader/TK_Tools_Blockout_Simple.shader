Shader "TK_Tools/Blockout_Simple" {
	Properties {
		[NoScaleOffset] Texture2D_6bf2622e99254ad798cefe547704e5aa ("Color Map", 2D) = "white" {}
		Color_68cec2170a24416792b457cab0667aca ("Color", Vector) = (1,1,1,0)
		Vector1_1bb5934550d2448098e692d6f41e0595 ("Smoothness", Float) = 1
		[ToggleUI] Boolean_ebb73031179c44548156a71417ad55ef ("Enable UV Scaling?", Float) = 0
		[ToggleUI] Boolean_f54c89eafb1e49e2aaf4d4ae57a45cc2 ("UV Scaling - Wall?", Float) = 0
		[ToggleUI] Boolean_13f8381140fc41cf87da16d1146d7daf ("UV Scaling - Floor?", Float) = 0
